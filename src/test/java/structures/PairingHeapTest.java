...
public class PairingHeapTest {
    ...
    public static void main (String[] args) {
        ...
        PairingHeap<Integer, String> heapA = new PairingHeap<>(PairingHeap.Type.MIN);
        ...
        PairingHeap<Integer, String> cloneA = heapA.cloneHeap();


        // Test merging.
        PairingHeap<Integer, String> heapB = new PairingHeap<>(PairingHeap.Type.MIN);
        ...
        PairingHeap<Integer, String> heapC = PairingHeap.merge(cloneA, heapB);
        ...
        PairingHeap<Integer, Integer> testHeap = new PairingHeap<>(PairingHeap.Type.MAX);
        int i = 0;
        while (i < 100000) {
